...
path = os.getcwd()
semestre = "2019-2" # Esto se cambia cada semestre, antes decia 2019-1 ahora dice 2019-2
trabajos = path+"/Trabajos"+semestre+"/"
lineaInicialParaElSemestre = 284 #Esto se cambia cada semestre, antes decia 217 y es la linea donde empieza a leer, ahora dice 284
