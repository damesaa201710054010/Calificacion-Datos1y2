...
Usage: python3 update_grades.py {ed1|ed2} {32|33} {1|2|..|12}.
...
SPREADSHEETS_ID_LIST = {
                        "ED1": {
                                "32": "1Ryv2XpbcMfgWSJ98USZjqa9lrXQi2mj7JIu_4gcesNY",  # Martes
                                "33": "1PhnNwYvc4gmchBioYfPmDYn6C7M71EWvSC5VUglW8rM"   # Jueves
                               },
                        "ED2": {}
                       }
...
def get_grades(students, activity_number):
    ...
    for student in students:
        entry = (student[2], student[activity_number+5]) # Tuple of student ID and grade
        grades.append(entry)
...
def get_ids_from_sheet(sheet, sheet_id):
    ...
    """
    # For now, this means that it only works with one type of activity.
    result = sheet.values().get(spreadsheetId=sheet_id, range="Talleres en Sala!A4:A23").execute() 
...
def bad_usage():
    ...
    """
    print("Usage: python3 update_grades.py {ed1|ed2} {32|33} {1|2|..|12}")
    exit(1)
